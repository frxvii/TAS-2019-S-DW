...
public class MeshWriter : MonoBehaviour
{
    ...
    private void _ComputeMesh()
    {
        ...
        _verts[0] = new Vector3(0,0,0);
        _verts[1] = new Vector3(1,0,0); //* (Mathf.Sin(Time.time) + 1);
        _verts[2] = new Vector3(0,1,0); //* (Mathf.Cos(Time.time) + 1);
        _verts[3] = new Vector3(1,0,0);
        _verts[4] = new Vector3(0,1,0);
        _verts[5] = new Vector3(1,1,0);
