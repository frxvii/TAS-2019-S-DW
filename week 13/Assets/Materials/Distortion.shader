	...
	SubShader
	{
		...
		Pass
		{
			...
			fixed4 frag (v2f i ) : SV_Target
			{
				...
				finalColor = ( tex2D( _MainTex, ( float4( appendResult3 , 0.0 ) + ( tex2D( _TextureSample0, appendResult3.xy ) * _DistortionStrenghth * -1.0 ) ).rg ) * tex2D( _ScanLine, appendResult13.xy ) );
				return finalColor;
			}
			ENDCG
		}
...
/*ASEBEGIN
Version=16600
-4.571429;46.28572;1450;724;1208.736;513.9595;1.656243;True;False
Node;AmplifyShaderEditor.ScreenPosInputsNode;2;-720.2442,-274.2212;Float;False;0;False;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.DynamicAppendNode;3;-470.9785,-246.2794;Float;False;FLOAT3;4;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.RangedFloatNode;5;-224.5264,59.3606;Float;False;Property;_DistortionStrenghth;DistortionStrenghth;2;0;Create;True;0;0;False;0;0;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;9;-124.0121,190.5085;Float;False;Constant;_Float0;Float 0;3;0;Create;True;0;0;False;0;-1;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;6;120.1317,-75.75381;Float;False;3;3;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;2;FLOAT;0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.SimpleAddOpNode;7;223.0703,-240.9529;Float;False;2;2;0;FLOAT3;0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;11;907.7446,43.01432;Float;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
...
ASEEND*/
//CHKSM=97B6D8C5F347D5172BE5F9A930B22C69EAF209DD